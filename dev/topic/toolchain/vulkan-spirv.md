...
current vulkan sdk version: 1.4.350.0
...
## Order 2
- `spirv-llvm-translator`: 21.1.8 ~~(same as `llvm`)~~ (lookup release date for `vulkan-sdk`)
- `glslang`: `vulkan-sdk-${vulkan-headers}`

## Order 3
- `libclc`: 21.1.8 (same as `llvm`)
