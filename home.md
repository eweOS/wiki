...
- :notebook_with_decorative_cover: [Installation Guide](https://os-wiki.ewe.moe/en/guides/manual-installation-guide) – Step-by-step guide to install eweOS manually on your system.
